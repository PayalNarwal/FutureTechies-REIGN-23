...
from ambulance import ambulance_class
...
##Buttons and Labels
        ...
        ambulance = Button(self.root, text = "Ambulance  \nHelp", font = ("courier new", 18, "bold"),justify=LEFT, bg = "#003A70", fg = "white",command=self.ambulance).place(x = 1115, y = 280,width=200, height = 100)
...
##Footer
    ...
    def ambulance(self) :
        self.new_win = Toplevel(self.root)  
        self.new_obj = ambulance_class(self.new_win)  
    def bmi(self) :
        self.new_win = Toplevel(self.root)  

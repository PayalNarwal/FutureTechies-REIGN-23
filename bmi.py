...
class bmi_class:
    def __init__(self,root):
        ...
        title_label = tk.Label(root, text="BMI Calculator", font=("Arial", 24), fg='white',bg="#003A70")
        title_label.pack(pady=20)

        height_label = tk.Label(root, text="Enter height (m):", font=("Arial", 14), fg='black',bg="#ADD8E6")
        height_label.pack()

        self.height_entry = tk.Entry(root, font=("Arial", 14))
        self.height_entry.pack()

        weight_label = tk.Label(root, text="Enter weight (kg):", font=("Arial", 14), fg='black',bg="#ADD8E6")
        weight_label.pack()

        self.weight_entry = tk.Entry(root, font=("Arial", 14))
        self.weight_entry.pack()

        calculate_button = tk.Button(root, text="Calculate", font=("Arial", 14),fg="white", bg='#003A70',command=self.calculate_bmi)
